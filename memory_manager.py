...
class ExtractedMemory(BaseModel):
    ...
    category: str = Field(default="none", description="Categoría de la memoria")
    content: Optional[str] = Field(default=None, description="Contenido o texto de la memoria")
    importance: Optional[int] = Field(default=0, description="Nivel de importancia del 1 al 5")
    ...
    def _init_vector_db(self):
        ...
        try:
            self.vectorstore = Chroma(
                ...
                embedding_function=GoogleGenerativeAIEmbeddings(model="text-embedding-3-large"),
